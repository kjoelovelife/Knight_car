...
<launch>
   <arg name="env_script_path" default="~/Knight_car/ros_version/kinetic/environment.sh"/>
	"""
	
	def make_line(name):
		space = " "*(13-len(name))
		p = """<machine name="%s"  %s address="%s.local" %s user="icshop" env-loader="$(arg env_script_path)"/>"""
